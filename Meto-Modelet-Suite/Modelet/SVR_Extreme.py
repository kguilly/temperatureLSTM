...
import os
os.environ["CUDA_VISIBLE_DEVICES"] = "-1" #str(ID) # Randomly select GPU
...
global_path = "cache/"+m.station+"_SVR_"+str(top_range) +"_" +"Seq_"+str(seq)+"_"+m.test_feature_list[0]+"_all"
