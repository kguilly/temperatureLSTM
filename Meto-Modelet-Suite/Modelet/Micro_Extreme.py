...
stationList = ['BMTN', 'CCLA', 'FARM', 'HUEY', 'LXGN']  # include your station list here
...
if len(sys.argv) > 1 and len(sys.argv) < 4:
    ...
    print("python modelet_name (say, kentucky_macro.py) station_name (say, BMTN) parmaID (say, 1), top (say, 1)")
    exit(0)
...
if len(sys.argv) == 4:
    ...
    seq = int(seq_1)
    if seq % 5 != 0 or seq < 5:
        print("Please check the seq value")
        exit(0)
    m.seq = seq
'''
...
if paramID == 1:
    ...
    m.feature_list_full = ['Year', 'Month', 'Day', 'Hour', 'Minute', 'TAIR', 'THMP', 'TDPT', 'ST02', 'SM02', 'SRAD', 'PRES', 'WDSD', 'RELH', 'DayOfTheYear', 'WSSD']
    m.feature_list_full_value = ['TAIR', 'THMP', 'TDPT', 'ST02', 'SM02', 'SRAD', 'PRES', 'WDSD', 'RELH', 'DayOfTheYear', 'WSSD']

    m.wrf_feature_list_full = ['Year', 'Month', 'Date', 'Hour', 'Minute', 'ATT66', 'ATT67', 'ATT59', 'ATT111', 'ATT32',
                               'ATT94', 'ATT28', 'ATT69', 'ATT109', 'ATT68']
    m.wrf_feature_list_value = ['ATT66', 'ATT67', 'ATT59', 'ATT111', 'ATT32', 'ATT94', 'ATT28', 'ATT69', 'ATT109',
                                'ATT68']

if paramID == 2:
    m.test_feature_list = ['RELH']
    m.feature_list_full = ['Year', 'Month', 'Day', 'Hour', 'Minute', 'RELH','SRAD', 'WSSD', 'WDSD', 'WSMX', 'WSPD', 'WSMN', 'THMP', 'PRES', 'TAIR']
...
if paramID == 3:
    m.test_feature_list = ['ST04']
    m.feature_list_full = ['Year', 'Month', 'Day', 'Hour', 'Minute', 'ST04', 'ST08', 'THMP', 'TAIR', 'TDPT', 'SM02', 'SRAD', 'PRES', 'DayOfTheYear', 'WSMN']
    m.feature_list_full_value = ['ST04', 'ST08', 'THMP', 'TAIR', 'TDPT', 'SM02', 'SRAD', 'PRES', 'DayOfTheYear', 'WSMN']

    m.wrf_feature_list_full = ['Year', 'Month', 'Date', 'Hour', 'Minute', 'ATT59', 'ATT111', 'ATT66', 'ATT67', 'ATT32', 'ATT28', 'ATT109', 'ATT69', 'ATT68', 'ATT33', 'ATT29']
    m.wrf_feature_list_value = ['ATT59', 'ATT111', 'ATT66', 'ATT67', 'ATT32', 'ATT28', 'ATT109', 'ATT69', 'ATT68', 'ATT33', 'ATT29']
    T_start_date = "0807"

if paramID == 4:
    m.test_feature_list = ['WSPD']
    m.feature_list_full = ['Year', 'Month', 'Day', 'Hour', 'Minute', 'WSPD', 'WSMX', 'WSMN', 'WSSD', 'PRES', 'ST40', 'RELH', 'SM02']
    m.feature_list_full_value = ['WSPD', 'WSMX', 'WSMN', 'WSSD', 'PRES', 'ST40', 'RELH', 'SM02']

    m.wrf_feature_list_full = ['Year', 'Month', 'Date', 'Hour', 'Minute', 'ATT8', 'ATT73', 'ATT89', 'ATT115', 'ATT98',
                               'ATT23', 'ATT18', 'ATT121', 'ATT101', 'ATT13']
    m.wrf_feature_list_value = ['ATT8', 'ATT73', 'ATT89', 'ATT115', 'ATT98', 'ATT23', 'ATT18', 'ATT121', 'ATT101',
                                'ATT13']

if paramID == 5:
    m.test_feature_list = ['PRES']
    m.feature_list_full = ['Year', 'Month', 'Day', 'Hour', 'Minute', 'PRES', 'TDPT', 'TAIR', 'THMP', 'ST02', 'WSMN', 'WSPD']
...
if paramID == 6:
    m.test_feature_list = ['SM04']
    m.feature_list_full = ['Year', 'Month', 'Day', 'Hour', 'Minute', 'SM04', 'SM08', 'ST40', 'TAIR', 'THMP', 'TDPT', 'DayOfTheYear', 'WSMN', 'WSPD']
    m.feature_list_full_value = ['SM04', 'SM08', 'ST40', 'TAIR', 'THMP', 'TDPT', 'DayOfTheYear', 'WSMN', 'WSPD']

    m.wrf_feature_list_full = ['Year', 'Month', 'Date', 'Hour', 'Minute', 'ATT61', 'ATT62', 'ATT70', 'ATT98', 'ATT101', 'ATT122', 'ATT1', 'ATT124', 'ATT17', 'ATT127', 'ATT41']
    m.wrf_feature_list_value = ['ATT61', 'ATT62', 'ATT70', 'ATT98', 'ATT101', 'ATT122', 'ATT1', 'ATT124', 'ATT17', 'ATT127', 'ATT41']
    T_start_date = "0807"
...
global_path = "cache/"+m.station+"_LSTM_mib_"+str(top_range) +"_"+m.test_feature_list[0]+"_all"
...
print(threshold, top_range, len(train_y))
...
test_x = x_scaler.transform(train_x)
x_test = test_x

test_y = y_scaler.transform(train_y)
y_test = test_y
