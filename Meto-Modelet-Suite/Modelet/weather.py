...
class Weather():
    ...
    # This module process the Kentucky Mesonet data
    def read_kentucky_file(self, year='2017', year_during=1, start_date="0101", during=1, shift=None, seq=5):
        print("Reading Kentucky Mesonet File")
        last_year = False
        train_y_all = pd.DataFrame(columns=self.test_feature_list)
